...
| [**AI Snake Game**](https://claude.site/artifacts/d059cdc0-73fb-42cb-8505-e985f30433eb)          | [@mmnopqrs](https://x.com/mmnopqrs)  The idea of creating an AI using an AI is closer than felt.<br/>I created the snake game below using AI that is also played by an AI.<br/>Claude Sonnet 3.5 is magic.<br/>Test it using this link and remix it. Let's see if we can make the AI win it! | ![7348794e1c54b7d128870a46254613b0.jpeg](https://ice.frostsky.com/2024/07/21/7348794e1c54b7d128870a46254613b0.jpeg) | ✅Avaliable |
